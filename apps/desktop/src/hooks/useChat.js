...
export function useChat() {
    const { messages, isTyping, selectedModel, selectedAgent, isLocal, addMessage, updateMessage, clearMessages, setTyping, setSelectedModel, setSelectedAgent, setIsLocal, } = useChatStore();
